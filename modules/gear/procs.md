...
```javascript
{
    ...
    color: '#4169E1',
    icon: 'https://database.turtlecraft.gg/images/icons/large/inv_misc_bone_dragonskull_01.png',
    effect: {
        type: 'statBuff',
...
```javascript
{
    ...
    color: '#8B4513',
    icon: 'https://database.turtlecraft.gg/images/icons/large/inv_trinket_naxxramas05.png',
    modifiesStats: (baseStats) => baseStats
}
```
