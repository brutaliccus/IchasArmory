...
## References
- [Water Shield (51536)](https://database.turtlecraft.gg/?spell=51536): 3 globes, 130 mana when struck, 3s ICD (we use 4s per your spec).
- [Totem of Tides (58146)](https://database.turtlecraft.gg/?item=58146): When Water Shield procs from being struck, releases tide: 25–33 Frost damage to enemies within 10 yards.
